...
namespace TicTacToeTests
{
    public class WinDeciderTests
    {
        ...
        public void CheckIfGetGameStateReturnsHorizontalWin()
        {
            ...
            var coord1 = new Coordinate {X = 0, Y = 2};
            var coord2 = new Coordinate {X = 1, Y = 2};
            var coord3 = new Coordinate {X = 2, Y = 2};
        ...
        {
            var board = new Board(3);
            var coord1 = new Coordinate {X = 1, Y = 0};
            var coord2 = new Coordinate {X = 1, Y = 1};
            var coord3 = new Coordinate {X = 1, Y = 2};
            board.UpdateSquare(coord1, 'X');
            board.UpdateSquare(coord2, 'X');
            board.UpdateSquare(coord3, 'X');
        ...
        {
            var board = new Board(3);
            var coord1 = new Coordinate {X = 2, Y = 0};
            var coord2 = new Coordinate {X = 1, Y = 1};
            var coord3 = new Coordinate {X = 0, Y = 2};
            board.UpdateSquare(coord1, 'X');
            board.UpdateSquare(coord2, 'X');
            board.UpdateSquare(coord3, 'X');
